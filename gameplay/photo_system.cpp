...
private:
    ...
    static void CaptureEntitiesInFrame(GameScene& scene, float frameX, float frameY, float frameWidth, float frameHeight, float& capturedMaxRight, float& capturedMaxBottom)
    {
            for (const auto& entity : scene.m_entities)
            {
                ...
                // ・ｽ・ｽ・ｽ・ｽ・ｽﾅ補正・ｽFrole ・ｽ・ｽ Solid ・ｽﾌ場合・ｽﾍ必・ｽ・ｽ Foreground ・ｽﾉゑｿｽ・ｽ・ｽ
    ...
    static void CaptureTilesInFrame(GameScene& scene, float frameX, float frameY, float frameWidth, float frameHeight, float& capturedMaxRight, float& capturedMaxBottom)
    {
            ...
            for (int row = topRow; row <= bottomRow; ++row)
            {
                for (int column = leftColumn; column <= rightColumn; ++column)
                {
                    ...
                    // ・ｽﾏ更・ｽ_: CSV ・ｽ・ｽ 1 ・ｽﾆゑｿｽ・ｽﾄゑｿｽ・ｽ・ｽu・ｽn・ｽﾊ」・ｽ^・ｽC・ｽ・ｽ・ｽﾍ撮・ｽe・ｽ・ｽ・ｽﾈゑｿｽ
                    if (tileValue == 1)
                    {
                        continue;
                    }
    ...
    static bool UpdatePlacementPreview(GameScene& scene, float& spawnX, float& spawnY, float& spawnWidth, float& spawnHeight)
    {
        ...
        // ・ｽ}・ｽE・ｽX・ｽi・ｽX・ｽN・ｽ・ｽ・ｽ[・ｽ・ｽ・ｽj・ｽ・ｽ・ｽ・ｽ[・ｽ・ｽ・ｽh・ｽ・ｽ・ｽW・ｽﾖ変奇ｿｽ・ｽi・ｽJ・ｽ・ｽ・ｽ・ｽX・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽj

        // ・ｽE・ｽX・ｽe・ｽB・ｽb・ｽN・ｽp・ｽﾌ会ｿｽ・ｽz・ｽJ・ｽ[・ｽ\・ｽ・ｽ・ｽi・ｽ・ｽ・ｽ[・ｽ・ｽ・ｽh・ｽ・ｽ・ｽW・ｽj
        const float mapWidth = scene.GetMapPixelWidth();
        const float mapHeight = scene.GetMapPixelHeight();
        ...
        // ・ｽ・ｽ・ｽﾍ撰ｿｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽA・ｽc・ｽﾌみマ・ｽb・ｽv・ｽ・ｽﾉク・ｽ・ｽ・ｽ・ｽ・ｽv
        (void)mapWidth; // ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽs・ｽ・ｽﾈゑｿｽ・ｽﾌで厄ｿｽ・ｽg・ｽp・ｽi・ｽx・ｽ・ｽ・ｽ}・ｽ・ｽ・ｽj
        ...
        // ・ｽﾅ終・ｽI・ｽﾈカ・ｽ[・ｽ\・ｽ・ｽ・ｽi・ｽ・ｽ・ｽ[・ｽ・ｽ・ｽh・ｽ・ｽ・ｽW・ｽj
        const float cursorWorldX = padCursorWorldX;
        const float cursorWorldY = padCursorWorldY;

        // ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽO・ｽ・ｽ・ｽﾄプ・ｽ・ｽ・ｽr・ｽ・ｽ・ｽ[・ｽ\・ｽ・ｽ・ｽi・ｽz・ｽu・ｽm・ｽ・ｽ・ｽ IsPhotoPlacementValid ・ｽﾉゑｿｽ髞ｻ・ｽ・ｽj
        ...
        // ・ｽ・ｽ・ｽz・ｽJ・ｽ[・ｽ\・ｽ・ｽ・ｽﾌス・ｽN・ｽ・ｽ・ｽ[・ｽ・ｽ・ｽ・ｽ・ｽW・ｽ・ｽ・ｬ・ｽ・ｽ・ｽﾄト・ｽ・ｽ・ｽC・ｽ・ｽ・ｽ・ｽﾉ使・ｽ・ｽ
