...
#define gCameraTargetOffsetX (game_scene_detail::GetActiveGameScene()->Tuning().cameraTargetOffsetX)
#define gCameraTargetOffsetY (game_scene_detail::GetActiveGameScene()->Tuning().cameraTargetOffsetY)
#define gCameraLookAheadOffsetX (game_scene_detail::GetActiveGameScene()->Tuning().cameraLookAheadOffsetX)
#define gCameraLookAheadResponse (game_scene_detail::GetActiveGameScene()->Tuning().cameraLookAheadResponse)
#define gCameraLookAheadReturnResponse (game_scene_detail::GetActiveGameScene()->Tuning().cameraLookAheadReturnResponse)
#define gCameraLookAheadCatchUpSpeedX (game_scene_detail::GetActiveGameScene()->Tuning().cameraLookAheadCatchUpSpeedX)
#define gCameraDeadZoneY (game_scene_detail::GetActiveGameScene()->Tuning().cameraDeadZoneY)
#define gCameraDeadZoneFollowSpeedY (game_scene_detail::GetActiveGameScene()->Tuning().cameraDeadZoneFollowSpeedY)
#define gCameraDeadZoneDownMaxSpeedY (game_scene_detail::GetActiveGameScene()->Tuning().cameraDeadZoneDownMaxSpeedY)
#define gCameraDeadZoneStrengthRiseResponse (game_scene_detail::GetActiveGameScene()->Tuning().cameraDeadZoneStrengthRiseResponse)
#define gCameraDeadZoneStrengthFallResponse (game_scene_detail::GetActiveGameScene()->Tuning().cameraDeadZoneStrengthFallResponse)
#define gCameraDeadZoneDownStrengthResponse (game_scene_detail::GetActiveGameScene()->Tuning().cameraDeadZoneDownStrengthResponse)
