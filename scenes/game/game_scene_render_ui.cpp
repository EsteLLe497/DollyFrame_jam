    ...
    float viewScale) const
{
    ...
    // ï¿½eï¿½Nï¿½Xï¿½`ï¿½ï¿½ï¿½Tï¿½Cï¿½Y sinrin10
    ...
    // ï¿½eï¿½Nï¿½Xï¿½`ï¿½ï¿½ï¿½Tï¿½Cï¿½Y sinrin11
    ...
    // ï¿½`ï¿½ï¿½Tï¿½Cï¿½Yï¿½iï¿½ï¿½Ê—Ìˆï¿½j
    const float drawW = viewWidth;
    const float drawH = viewHeight;

    // ï¿½`ï¿½ï¿½Tï¿½Cï¿½Yï¿½iï¿½ï¿½Ê—Ìˆï¿½jbg1
    const float drawW1 = viewWidth;
    const float drawH1 = viewHeight;

    // ï¿½pï¿½ï¿½ï¿½ï¿½ï¿½bï¿½Nï¿½Xï¿½Wï¿½ï¿½ï¿½i0.0 = ï¿½Å’ï¿½wï¿½iï¿½A1.0 = ï¿½Jï¿½ï¿½ï¿½ï¿½ï¿½Æ“ï¿½ï¿½ï¿½ï¿½j
    // ï¿½Kï¿½vï¿½É‰ï¿½ï¿½ï¿½ï¿½Ä‚ï¿½ï¿½ï¿½ï¿½ï¿½ÏXï¿½iï¿½ï¿½: 0.2f, 0.5f, 1.0fï¿½j
    const float parallaxX = 0.45f;
	const float parallaxY = 0.45f;//0.0f; // ŒÅ’è”wŒi‚É‚µ‚½‚¢ê‡‚Íí‚É0‚É‚·‚é

<<<<<<< HEAD
    // ƒpƒ‰ƒ‰ƒbƒNƒXŒW”i0.0 = ŒÅ’è”wŒiA1.0 = ƒJƒƒ‰‚Æ“¯‘¬j
    // •K—v‚É‰ž‚¶‚Ä‚±‚±‚ð•ÏXi—á: 0.2f, 0.5f, 1.0fjbg1
    const float parallaxX1 = 1.0f;
=======
    // ï¿½pï¿½ï¿½ï¿½ï¿½ï¿½bï¿½Nï¿½Xï¿½Wï¿½ï¿½ï¿½i0.0 = ï¿½Å’ï¿½wï¿½iï¿½A1.0 = ï¿½Jï¿½ï¿½ï¿½ï¿½ï¿½Æ“ï¿½ï¿½ï¿½ï¿½j
    // ï¿½Kï¿½vï¿½É‰ï¿½ï¿½ï¿½ï¿½Ä‚ï¿½ï¿½ï¿½ï¿½ï¿½ÏXï¿½iï¿½ï¿½: 0.2f, 0.5f, 1.0fï¿½jbg1
    const float parallaxX1 = 0.45f;
>>>>>>> 50985d3d810e6346b427ab60876fe30a7039adf2
    const float parallaxY1 = 0.45f;

    // ï¿½Jï¿½ï¿½ï¿½ï¿½ï¿½Ìƒï¿½ï¿½[ï¿½ï¿½ï¿½hï¿½Ê’uï¿½ï¿½ï¿½gï¿½ï¿½ï¿½ï¿½UVï¿½Xï¿½Nï¿½ï¿½ï¿½[ï¿½ï¿½ï¿½Ê‚ï¿½ï¿½vï¿½Zï¿½i0..1ï¿½j
	...
	if (scrollV < 0.0f) scrollV += 0;// ŒÅ’è”wŒi‚É‚µ‚½‚¢ê‡‚Íí‚É0‚É‚·‚é

    // ï¿½Jï¿½ï¿½ï¿½ï¿½ï¿½Ìƒï¿½ï¿½[ï¿½ï¿½ï¿½hï¿½Ê’uï¿½ï¿½ï¿½gï¿½ï¿½ï¿½ï¿½UVï¿½Xï¿½Nï¿½ï¿½ï¿½[ï¿½ï¿½ï¿½Ê‚ï¿½ï¿½vï¿½Zï¿½i0..1ï¿½jbg1
    ...
    // UVï¿½ä‚©ï¿½ï¿½ï¿½Êï¿½Ì•ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½vï¿½Zï¿½iï¿½ï¿½/ï¿½E, ï¿½ï¿½/ï¿½ï¿½ï¿½j
    const float leftUVWidth = 1.0f - scrollU;
    const float rightUVWidth = scrollU;
	const float topUVHeight = 1.0f - scrollV;//0.0f; // ŒÅ’è”wŒi‚É‚µ‚½‚¢ê‡‚Íí‚É0‚É‚·‚é
    const float bottomUVHeight = scrollV;

    // UVï¿½ä‚©ï¿½ï¿½ï¿½Êï¿½Ì•ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½vï¿½Zï¿½iï¿½ï¿½/ï¿½E, ï¿½ï¿½/ï¿½ï¿½ï¿½jbg1
    const float leftUVWidth1 = 1.0f - scrollU1;
    const float rightUVWidth1 = scrollU1;
	const float topUVHeight1 = 1.0f - scrollV1;//0.0f; // ŒÅ’è”wŒi‚É‚µ‚½‚¢ê‡‚Íí‚É0‚É‚·‚é
    ...
    // ï¿½Åï¿½ï¿½`ï¿½æ•/ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½è‡’lï¿½iï¿½ï¿½ï¿½Ü‚ï¿½Éï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Î•`ï¿½ï¿½ï¿½È‚ï¿½ï¿½j
    constexpr float kMinDrawSize = 0.5f;

    // 4ï¿½ï¿½ï¿½ï¿½ï¿½Å•`ï¿½ï¿½Fï¿½ï¿½ï¿½ï¿½Aï¿½Eï¿½ï¿½Aï¿½ï¿½ï¿½ï¿½ï¿½Aï¿½Eï¿½ï¿½
    // ï¿½ï¿½ï¿½ï¿½
